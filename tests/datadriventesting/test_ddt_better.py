...
@pytest.mark.parametrize("user_cred", read_credentials_from_excel("/Home/Downloads/PycharmProjects/Py1xAPIAutomation/tests/datadriventesting/Milind_Trivedi.xlsx"))
